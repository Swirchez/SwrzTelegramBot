...
def help_user(message):
    bot.send_message(message.chat.id, "Здраствуйте я телеграм бот который даёт советы о том как можно уменьшить загрязнения окружающей среды, пиши команду /help - чтобы узнать все команды бота!")
